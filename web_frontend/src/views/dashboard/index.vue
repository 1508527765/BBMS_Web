    ...
    <div class="page-header-content">
      ...
      <div class="content">
        <div class="content-title">
          {{ $t('dashboard.早安') }}，{{ currentUser.name
          }}<span class="welcome-text">，{{ $t('dashboard.祝你开心每一天') }}</span>
        </div>
      ...
      <a-row :gutter="24">
        <a-col :xl="16" :lg="24" :md="24" :sm="24" :xs="24">
          <a-card
            ...
            :bordered="false"
            :title="$t('dashboard.进行中的项目')"
            :body-style="{ padding: 0 }"
          >
            <a slot="extra">{{ $t('dashboard.全部项目') }}</a>
            <div>
              <a-card-grid
          ...
          <a-card :loading="loading" :title="$t('dashboard.动态')" :bordered="false">
            <a-list>
        ...
        >
          ...
          >
            <div class="item-group">
              ...
              <a-button size="small" type="primary" ghost icon="plus"
                >{{ $t('dashboard.添加') }}</a-button
              >
            </div>
          </a-card>
          <a-card
            :title="$t('dashboard.XX指数')"
            style="margin-bottom: 24px"
          ...
          <a-card :loading="loading" :title="$t('dashboard.团队')" :bordered="false">
            <div class="members">
              <a-row>
                <a-col
                  :span="12"
