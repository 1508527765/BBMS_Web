      ...
      <el-row>
        <el-col :span="24">
          <el-button
            ...
            size="mini"
            :disabled="!searchForm.dateRange || alarmList.length === 0"
            @click="handleExport"
  ...
  methods: {
    ...
    async fetchAlarmList() {
      ...
      try {
        ...
        this.alarmList = Array.isArray(pageData.rows) ? pageData.rows : [];
    ...
    async handleExport() {
      ...
      try {
        ...
        await this.download(
          ...
          `alarm_record_${startDate}-${endDate}.csv`
        );
