...
async def add_system_config(
    ...
    add_config_result = ConfigService.add_config_services(request, query_db, add_config)
...
async def refresh_system_config(request: Request, query_db: Session = Depends(get_db)):
    refresh_config_result = ConfigService.refresh_sys_config_services(request, query_db)
...
async def delete_system_config(request: Request, config_ids: str, query_db: Session = Depends(get_db)):
    ...
    delete_config_result = ConfigService.delete_config_services(request, query_db, delete_config)
