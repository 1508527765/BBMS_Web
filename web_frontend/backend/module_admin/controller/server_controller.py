...
async def get_monitor_server_info(request: Request, lang: str = Query(default='en', alias='lang')):
    # 获取全量数据
    server_info_query_result = await ServerService.get_server_monitor_info(lang=lang)
    logger.info('获取成功')
