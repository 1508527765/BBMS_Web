...
async def add_system_dict_type(
    ...
    add_dict_type_result = DictTypeService.add_dict_type_services(request, query_db, add_dict_type)
...
async def edit_system_dict_type(
    ...
    edit_dict_type_result = DictTypeService.edit_dict_type_services(request, query_db, edit_dict_type)
...
async def refresh_system_dict(request: Request, query_db: Session = Depends(get_db)):
    refresh_dict_result = DictTypeService.refresh_sys_dict_services(request, query_db)
...
async def delete_system_dict_type(request: Request, dict_ids: str, query_db: Session = Depends(get_db)):
    ...
    delete_dict_type_result = DictTypeService.delete_dict_type_services(request, query_db, delete_dict_type)
...
async def query_system_dict_type_options(request: Request, query_db: Session = Depends(get_db)):
    dict_type_query_result = DictTypeService.get_dict_type_list_services(
...
async def query_system_dict_type_data(request: Request, dict_type: str, query_db: Session = Depends(get_db)):
    # 获取全量数据
    dict_data_query_result = await DictDataService.query_dict_data_list_from_cache_services(dict_type)
    logger.info('获取成功')
...
async def get_system_dict_data_list(
    ...
    # 获取分页数据
    dict_data_page_query_result = DictDataService.get_dict_data_list_services(
...
async def add_system_dict_data(
    ...
    add_dict_data_result = DictDataService.add_dict_data_services(request, query_db, add_dict_data)
...
async def edit_system_dict_data(
    ...
    edit_dict_data_result = DictDataService.edit_dict_data_services(request, query_db, edit_dict_data)
...
async def delete_system_dict_data(request: Request, dict_codes: str, query_db: Session = Depends(get_db)):
    ...
    delete_dict_data_result = DictDataService.delete_dict_data_services(request, query_db, delete_dict_data)
...
async def export_system_dict_data_list(
    ...
    # 获取全量数据
    dict_data_query_result = DictDataService.get_dict_data_list_services(
