...
class OperationLogDao:
    ...
    @classmethod
    async def get_operation_log_list(cls, db: Session, query_object: OperLogPageQueryModel, is_page: bool = False):
        """
        根据查询参数获取操作日志列表信息
        ...
        operation_log_list = PageUtil.paginate(db, query, query_object.page_num, query_object.page_size, is_page)

        return operation_log_list

    @classmethod
    async def add_operation_log_dao(cls, db: Session, operation_log: OperLogModel):
        """
        新增操作日志数据库操作
    ...
    @classmethod
    async def delete_operation_log_dao(cls, db: Session, operation_log: OperLogModel):
        """
        删除操作日志数据库操作
        ...
        :return:
        """
        db.execute(delete(SysOperLog).where(SysOperLog.oper_id.in_([operation_log.oper_id])))

    @classmethod
    async def clear_operation_log_dao(cls, db: Session):
        """
        清除操作日志数据库操作
...
class LoginLogDao:
    ...
    @classmethod
    async def get_login_log_list(cls, db: Session, query_object: LoginLogPageQueryModel, is_page: bool = False):
        """
        根据查询参数获取登录日志列表信息
        ...
        login_log_list = PageUtil.paginate(db, query, query_object.page_num, query_object.page_size, is_page)

        return login_log_list

    @classmethod
    async def add_login_log_dao(cls, db: Session, login_log: LogininforModel):
        """
        新增登录日志数据库操作
    ...
    @classmethod
    async def delete_login_log_dao(cls, db: Session, login_log: LogininforModel):
        """
        删除登录日志数据库操作
        ...
        :return:
        """
        db.execute(delete(SysLogininfor).where(SysLogininfor.info_id.in_([login_log.info_id])))

    @classmethod
    async def clear_login_log_dao(cls, db: Session):
        """
        清除登录日志数据库操作
        ...
        :return:
        """
        db.execute(delete(SysLogininfor))
