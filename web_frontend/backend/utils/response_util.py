...
class ResponseUtil:
    ...
    def unauthorized(
        cls,
        msg: str = 'Login information has expired, failed to access system resources',
        data: Optional[Any] = None,
        rows: Optional[Any] = None,
        dict_content: Optional[Dict] = None,
        model_content: Optional[BaseModel] = None,
    ...
    def forbidden(
        cls,
        msg: str = 'This user does not have permission for this interface',
        data: Optional[Any] = None,
        rows: Optional[Any] = None,
        dict_content: Optional[Dict] = None,
        model_content: Optional[BaseModel] = None,
